/*
 * CKDBDataNodeLoader.h - this file defines the class that has been created to
 ...
 *
 * $Id: CKDBDataNodeLoader.h,v 1.1 2008/01/17 16:26:27 drbob Exp $
 */
#ifndef __CKDBDATANODELOADER_H
#define __CKDBDATANODELOADER_H
	...
	public CKFWThread
{
	public:
		 ...
		 * around.
		 */
		CKDBDataNodeLoader( CKDBDataNodeLoader & anOther );
		 ...
		 */
		CKDBDataNodeLoader & operator=( CKDBDataNodeLoader & anOther );
		 ...
		 */
		static bool doLoad( CKDBDataNode *aNode, const CKString & aName );
		 ...
		 */
		bool operator==( const CKDBDataNodeLoader & anOther ) const;
		/*
		 * This method checks to see if the two CKDBDataNodeLoaders are
	...
	private:
		 ...
		 * CKDBDataNodeLoader object - ever! The static method doLoad()
