/*
 * CKPListDataNodeLoader.h - this file defines the class that has been created
 *                           to handle the asynchronous loading of the
 *                           plist file-based CKDataNode structures that are
 *                           in use in applications. The reason for this class
 ...
 *
 * $Id: CKPListDataNodeLoader.h,v 1.1 2008/01/17 16:43:52 drbob Exp $
 */
#ifndef __CKPLISTDATANODELOADER_H
#define __CKPLISTDATANODELOADER_H
	...
	public CKFWThread
{
	public:
		 ...
		 * around.
		 */
		CKPListDataNodeLoader( CKPListDataNodeLoader & anOther );
		 ...
		 */
		CKPListDataNodeLoader & operator=( CKPListDataNodeLoader & anOther );
		 ...
		 */
		static bool doLoad( CKPListDataNode *aNode, const CKString & aName );
		 ...
		 */
		bool operator==( const CKPListDataNodeLoader & anOther ) const;
		/*
		 * This method checks to see if the two CKPListDataNodeLoaders are
...
#endif	// __CKPLISTDATANODELOADER_H
